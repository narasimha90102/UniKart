 ...
 */
async function generateExcelReport(results, outputFileName = 'mobile_test_report.xlsx') {
  const workbook = new ExcelJS.Workbook();
  const worksheet = workbook.addWorksheet('E2E Mobile Test Report');
  ...
  titleCell.value = 'UNIKART MOBILE E2E AUTOMATION TEST REPORT';
  titleCell.font = { name: 'Segoe UI', size: 16, bold: true, color: { argb: 'FFFFFFFF' } };
  titleCell.fill = {
    type: 'pattern',
    pattern: 'solid',
    fgColor: { argb: 'FF10B981' } // Green brand color for mobile
  };
